...
DATA_PATH      <- "/Users/kahrens/MyProjects/JEL/Data"
...
#| echo: false
#| results: asis
#| tbl-cap: "Recruiter-honest folds with cluster-robust SE vs. IID-assumed folds. Both columns are median-of-medians over S = 5 seeds; K = 3; XGB 3 nuisance learner."
iid_seeds <- fit_dml_all_seeds(K = 3, learner = 9, xfit_mode = "iid")
iid_med   <- median_aggregate_dml(iid_seeds)
export_dml_table(
  list(
    "xclust (baseline)" = xgb_med,
    "IID-assumed folds"         = iid_med
  ),
  output    = "markdown",
  fmt       = 3,
  estimate  = "{estimate} ({std.error})",
...
#| echo: false
#| results: asis
#| tbl-cap: "K = 3 vs. K = 5. Both columns are median-of-medians over S = 5 seeds; XGB 3 nuisance learner; recruiter-honest folds; cluster-robust SE."
...
- Ahrens, A., V. Chernozhukov, C. Hansen, D. Kozbur, M. Schaffer and T. Wiemann. *An Introduction to Double/Debiased Machine Learning.* 
